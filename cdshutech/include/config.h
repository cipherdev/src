...
class Config {
    ...
    static std::string itcar_pkg_name;
    ...
    static std::string getROSPackage() {
        if (itcar_pkg_name.empty()) {
            ros::NodeHandle private_node_handle("~");
            if (!private_node_handle.getParam("itcar_pkg_name", itcar_pkg_name)) {
                itcar_pkg_name = "cdshutech";
            }
        }
        return itcar_pkg_name;
    }
